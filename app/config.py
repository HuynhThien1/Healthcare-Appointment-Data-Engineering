...
KAFKA_TOPICS = [
    ...
    os.getenv("TOPIC_SLOT_CODE_TEMPLATE", "healthcare.public.slot_code_template"),
    os.getenv("TOPIC_DOCTOR_SLOT", "healthcare.public.doctor_slot"),
    os.getenv("TOPIC_APPOINTMENT", "healthcare.public.appointment"),
    os.getenv("TOPIC_APPOINTMENT_TRANSACTION", "healthcare.public.appointment_transaction"),
